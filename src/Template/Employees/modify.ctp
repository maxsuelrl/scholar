<div class="form-clean">
    ...
    <?php
        ...
        echo $this->Form->control('name', ['label' => 'Nome', 'placeholder' => 'Nome do funcionário', 'class' => 'form-control']);
        echo $this->Form->control('rg', ['label' => 'RG', 'placeholder' => 'RG do funcionário', 'class' => 'form-control']);
        echo $this->Form->control('cpf', ['label' => 'CPF', 'placeholder' => 'CPF do funcionário', 'class' => 'form-control']);
        echo $this->Form->control('telephone', ['label' => 'Telefone', 'placeholder' => 'Telefone do funcionário', 'class' => 'form-control']);
        echo $this->Form->control('address', ['label' => 'Endereço', 'placeholder' => 'Endereço do funcionário', 'class' => 'form-control']);
        ...
        echo $this->Form->control('email', ['label' => 'Email', 'placeholder' => 'Email do funcionário', 'class' => 'form-control']);
